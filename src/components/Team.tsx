...
const members = [
  { img: t1, name: "রাতুল দাস", role: "চিফ সিনেমাটোগ্রাফার, সহ-প্ৰতিষ্ঠাতা ও ম্যানেজিং ডিরেক্টর (এম. ডি)" },
  { img: t3, name: "ইউসুফ আদনান", role: "সহ-প্রতিষ্ঠাতা ও চিফ এক্সিকিউটিং অফিসার (সি. ই. ও)" },
];
