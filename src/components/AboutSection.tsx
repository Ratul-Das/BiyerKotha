        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              বিয়ের কথা বাংলাদেশের একটি প্রিমিয়াম ফটোগ্রাফি ও সিনেম্যাটোগ্রাফি কোম্পানি। আমরা বিশ্বাস করি প্রতিটি মুহূর্তের নিজস্ব একটি গল্প আছে — আমাদের কাজ হলো সেই গল্পকে সবচেয়ে সুন্দরভাবে তুলে ধরা।
            </p>
